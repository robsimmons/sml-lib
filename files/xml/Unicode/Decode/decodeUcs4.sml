...
signature DecodeUcs4 =
   sig
      val getCharUcs4b  : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharUcs4l  : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharUcs4sb : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharUcs4sl : DecodeReader.state -> UniChar.Char * DecodeReader.state
   end
...
structure DecodeUcs4 : DecodeUcs4 = 
   struct
      open 
         UniChar UniClasses 
         DecodeReader DecodeError DecodeUtil
