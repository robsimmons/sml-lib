...
signature DecodeError = 
   sig
      datatype DecodeError =
          ERR_ILLEGAL_CHAR of Word8.word * string
        | ERR_NON_UNI_UCS4 of UniChar.Char
        | ERR_EOF_UCS4 of int * Word8.word list
        | ERR_NON_DIRECT_UTF7 of Word8.word
        | ERR_PADDING_UTF7 of UniChar.Char
        | ERR_ILLFORMED_UTF8 of Word8.word * int * int
        | ERR_ILLEGAL_UTF8 of Word8.word
        | ERR_INVALID_UTF8_SEQ of Word8.word list
        | ERR_EOF_UTF8 of int * int
        | ERR_NON_UNI_UTF8 of UniChar.Char * int
        | ERR_EOF_UCS2 of Word8.word
        | ERR_EOF_UTF16 of Word8.word
      ...
      exception DecodeError of DecodeReader.state * bool * DecodeError 
   end

structure DecodeError : DecodeError =
   struct
      open 
         DecodeReader UtilString UniChar 
