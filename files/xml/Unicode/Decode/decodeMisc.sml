signature DecodeMisc = 
   sig
      val getCharAscii  : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharEbcdic : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharEof    : DecodeReader.state -> UniChar.Char * DecodeReader.state
      val getCharLatin1 : DecodeReader.state -> UniChar.Char * DecodeReader.state
   end

structure DecodeMisc : DecodeMisc = 
   struct
      open 
         UniChar DecodeReader DecodeError
